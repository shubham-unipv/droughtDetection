// Sentinel-2 3-day Mosaic Time Series Export for Jodhpur District
...
years.forEach(function(year) {
  ...
  Export.table.toDrive({
    ...
    description: 'MosaicTimeSeries_Jodhpur_' + year,
    folder: 'L1C',
    fileNamePrefix: 'MosaicTimeSeries_Jodhpur_' + year,
    fileFormat: 'CSV'
  });
});