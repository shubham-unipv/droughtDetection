// Sentinel-2 3-day Mosaic Time Series Export for Amravati District
...
years.forEach(function(year) {
  ...
  Export.table.toDrive({
    ...
    description: 'MosaicTimeSeries_Amravati_' + year,
    folder: 'L1C',
    fileNamePrefix: 'MosaicTimeSeries_Amravati_' + year,
    fileFormat: 'CSV'
  });
});