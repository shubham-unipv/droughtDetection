...
"""
performance_output_file = "WithAgriculturalMask/ResultsBordaCountAdasyn/performance.txt"
...
# Save to CSV
file_path = 'WithAgriculturalMask/ResultsBordaCountAdasyn/output_file.csv'
...
output_file = "WithAgriculturalMask/ResultsBordaCountAdasyn/xgboost_test_results.txt"
correct_groups = 0
...
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_bar_plot_xgb.png")  # Save plot to file
plt.clf()  # Clear the current plot

# Save the SHAP summary plot as an image
shap.summary_plot(shap_values, X_test, feature_names=X_test.columns)
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_plot_xgb.png")  # Save plot to file
plt.clf()  # Clear the current plot
...
output_file = "WithAgriculturalMask/ResultsBordaCountAdasyn/rf_test_results.txt"
correct_groups = 0
total_groups = len(grouped_results)
...
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_bar_plot_rf.png")  # Save plot to file
plt.clf()  # Clear the current plot
...
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_plot_rf.png")  # Save plot to file
plt.clf()  # Clear the current plot
...
output_file = "WithAgriculturalMask/ResultsBordaCountAdasyn/bagging_test_results.txt"
correct_groups = 0
total_groups = len(grouped_results)
...
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_bar_plot_bagging.png")  # Save bar plot to file
plt.clf()  # Clear the current plot

# Plot the full SHAP summary plot to visualize feature impact on individual predictions
shap.summary_plot(shap_values_bagging, X_test, feature_names=X_test.columns)
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_plot_bagging.png")  # Save beeswarm plot to file
plt.clf()  # Clear the current plot
...
output_file = "WithAgriculturalMask/ResultsBordaCountAdasyn/gb_test_results.txt"
correct_groups = 0
total_groups = len(grouped_results)
...
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_bar_plot_gb.png")  # Save plot to file
plt.clf()  # Clear the current plot
...
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/shap_summary_plot_gb.png")  # Save plot to file
plt.clf()  # Clear the current plot
## *****************************************************************************************************************##
...
plt.savefig('WithAgriculturalMask/ResultsBordaCountAdasyn/model_performance_table.png')
plt.clf()  # Clear the current plot
## *****************************************************************************************************************##
...
# Save the plot
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/top_5_features_borda_count.png")
...
plt.tight_layout()
plt.savefig("WithAgriculturalMask/ResultsBordaCountAdasyn/model_metrics_top_features_borda_count.png")
plt.clf()
...
def plot_confusion_matrix(y_true, y_pred, model_name):
    ...
    plt.ylabel('True')
    plt.tight_layout()
    plt.savefig(f"WithAgriculturalMask/ResultsBordaCountAdasyn/confusion_matrix_{model_name.lower().replace(' ', '_')}.png")  # Save confusion matrix as an image
    plt.clf()  # Clear the current plot
